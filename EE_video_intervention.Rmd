...
```{r load dataset}
df_video_intervention <- haven::read_sav(here::here("Data","china_data","20210601data_video_intervention.sav"))
...
df_video_intervention$vaccination_status_flu = ifelse(df_video_intervention$LC_1==2,0,1)
...
df_video_intervention %>%
  ...
  summarise_at(vars(vaccine_hesitancy,  hope),
               list(~mean(.), ~sd(.), ~n()))
df_video_intervention %>%
  group_by(vaccination_status_flu) %>%
  summarise_at(vars(vaccine_hesitancy,  hope),
               list(~mean(.), ~sd(.), ~n()))
df_video_intervention %>%
  summarise_at(vars(vaccine_hesitancy,  hope),
...
summary(glm(data = df_video_intervention, vaccination_status_flu~hope+vaccine_hesitancy, family = "binomial"))
...
library(ggplot2)
ggplot(data = df_video_intervention, mapping = aes(x = vaccine_hesitancy,  fill = as.factor(QQ))) + 
...
# grouped by age
library(ggplot2)
ggplot(data = df_video_intervention, mapping = aes(x = vaccine_hesitancy,  fill = as.factor(age))) + 
  geom_density(alpha = 0.3) + 
  labs(x = "Vaccine hesitancy", y = "Density", title = "")  + 
...
# grouped by gender
library(ggplot2)
ggplot(data = df_video_intervention, mapping = aes(x = vaccine_hesitancy,  fill = as.factor(gender))) + 
  geom_density(alpha = 0.3) + 
  labs(x = "Vaccine hesitancy", y = "Density", title = "")  + 
...
library(ggplot2)
ggplot(data = df_video_intervention, mapping = aes(x = vaccine_hesitancy,  fill = as.factor(residence))) + 
  geom_density(alpha = 0.3) + 
  labs(x = "Vaccine hesitancy", y = "Density", title = "")  + 
...
# grouped by intervention
library(ggplot2)
ggplot(data = df_video_intervention, mapping = aes(x = covid19_vaccine_hesitancy,  fill = as.factor(QQ))) + 
  geom_density(alpha = 0.3) + 
...
# grouped by age
library(ggplot2)
ggplot(data = df_video_intervention, mapping = aes(x = covid19_vaccine_hesitancy,  fill = as.factor(age))) + 
  geom_density(alpha = 0.3) + 
  labs(x = "COVID-19 vaccine hesitancy", y = "Density", title = "")  + 
  theme(panel.background = element_rect())+ scale_fill_discrete(name = "Age group", labels = c("18 to 29", "30 to 39", "40 to 49", "50 to 59", "60 or above")) + theme(panel.grid=element_blank(),axis.line=element_line(size=0.5, colour="black"),panel.grid.minor = element_blank()) + # delete the the grid but save the axis
  theme_bw() # set background white
...
# grouped by gender
library(ggplot2)
ggplot(data = df_video_intervention, mapping = aes(x = covid19_vaccine_hesitancy,  fill = as.factor(gender))) + 
  geom_density(alpha = 0.3) + 
  labs(x = "COVID-19 vaccine hesitancy", y = "Density", title = "")  + 
  theme(panel.background = element_rect())+ scale_fill_discrete(name = "Gender", labels = c("Male", "Female")) +
  theme(panel.grid=element_blank(),axis.line=element_line(size=0.5, colour="black"),panel.grid.minor = element_blank()) + # delete the the grid but save the axis
...
# grouped by residence
library(ggplot2)
ggplot(data = df_video_intervention, mapping = aes(x = covid19_vaccine_hesitancy,  fill = as.factor(residence))) + 
  geom_density(alpha = 0.3) + 
  labs(x = "COVID-19 vaccine hesitancy", y = "Density", title = "")  + 
  theme(panel.background = element_rect())+ scale_fill_discrete(name = "Residence", labels = c("Rural", "Urban")) +
  theme(panel.grid=element_blank(),axis.line=element_line(size=0.5, colour="black"),panel.grid.minor = element_blank()) + # delete the the grid but save the axis
...
# grouped by education
library(ggplot2)
ggplot(data = df_video_intervention, mapping = aes(x = covid19_vaccine_hesitancy,  fill = as.factor(education))) + 
  geom_density(alpha = 0.3) + 
  labs(x = "COVID-19 vaccine hesitancy", y = "Density", title = "")  + 
  theme(panel.background = element_rect())+ scale_fill_discrete(name = "Education", labels = c("No primary school", "Primary school", "Middle school", "High school", "College/undergraduate", "Master's degree or above")) +
  theme(panel.grid=element_blank(),axis.line=element_line(size=0.5, colour="black"),panel.grid.minor = element_blank()) + # delete the the grid but save the axis
...
wtd.t.test(df_video_intervention_a$vaccine_hesitancy, df_video_intervention_control$vaccine_hesitancy,df_video_intervention_a$weight,df_video_intervention_control$weight)

wtd.t.test(df_video_intervention_a$covid19_vaccine_hesitancy, df_video_intervention_control$covid19_vaccine_hesitancy,df_video_intervention_a$weight,df_video_intervention_control$weight)

wtd.t.test(df_video_intervention_b$vaccine_hesitancy, df_video_intervention_control$vaccine_hesitancy,df_video_intervention_b$weight,df_video_intervention_control$weight)

wtd.t.test(df_video_intervention_b$covid19_vaccine_hesitancy, df_video_intervention_control$covid19_vaccine_hesitancy,df_video_intervention_b$weight,df_video_intervention_control$weight)

wtd.t.test(df_video_intervention_c$vaccine_hesitancy, df_video_intervention_control$vaccine_hesitancy,df_video_intervention_c$weight,df_video_intervention_control$weight)

wtd.t.test(df_video_intervention_c$covid19_vaccine_hesitancy, df_video_intervention_control$covid19_vaccine_hesitancy,df_video_intervention_c$weight,df_video_intervention_control$weight)


#between treatments

df_vaccine_hesitancy_treatment = subset(df_video_intervention,QQ==1|QQ==2|QQ==3,select=c(QQ,vaccine_hesitancy,covid19_vaccine_hesitancy,weight))
...
df_video_intervention %>%
  ...
  srvyr::select(income_level, education_level, residence, hope, vaccination_status) %>%
  srvyr::summarise(
...
df_video_intervention %>%
  ...
  select(income_level, education_level, residence, hope, vaccination_status_flu) %>%
  srvyr::summarise(
    hope_rural_yes = mean(hope[residence == 1 & vaccination_status_flu == 1]),
    hope_rural_yes_n = sum(residence == 1 & vaccination_status_flu == 1),
    hope_rural_yes_upp = mean(hope[residence == 1 & vaccination_status_flu == 1]) + 1.96 * sd(hope[residence == 1 & vaccination_status_flu == 1])/sqrt(hope_rural_yes_n),
    hope_rural_yes_low = mean(hope[residence == 1 & vaccination_status_flu == 1]) - 1.96 * sd(hope[residence == 1 & vaccination_status_flu == 1])/sqrt(hope_rural_yes_n),
    
    hope_rural_no = mean(hope[residence == 1 & vaccination_status_flu == 0]),
    hope_rural_no_n = sum(residence == 1 & vaccination_status_flu == 0),
    hope_rural_no_upp = mean(hope[residence == 1 & vaccination_status_flu == 0]) + 1.96 * sd(hope[residence == 1 & vaccination_status_flu == 0])/sqrt(hope_rural_no_n),
    hope_rural_no_low = mean(hope[residence == 1 & vaccination_status_flu == 0]) - 1.96 * sd(hope[residence == 1 & vaccination_status_flu == 0])/sqrt(hope_rural_no_n),
    
    hope_poor_yes = mean(hope[income_level == 1 & vaccination_status_flu == 1]),
    hope_poor_yes_n = sum(income_level == 1 & vaccination_status_flu == 1),
    hope_poor_yes_upp = mean(hope[income_level == 1 & vaccination_status_flu == 1]) + 1.96 * sd(hope[income_level == 1 & vaccination_status_flu == 1])/sqrt(hope_poor_yes_n),
    hope_poor_yes_low = mean(hope[income_level == 1 & vaccination_status_flu == 1]) - 1.96 * sd(hope[income_level == 1 & vaccination_status_flu == 1])/sqrt(hope_poor_yes_n),
    
    hope_poor_no = mean(hope[income_level == 1 & vaccination_status_flu == 0]),
    hope_poor_no_n = sum(income_level == 1 & vaccination_status_flu == 0),
    hope_poor_no_upp = hope_poor_no + 1.96 * sd(hope[income_level == 1 & vaccination_status_flu == 0])/sqrt(hope_rural_yes_n),
    hope_poor_no_low = hope_poor_no - 1.96 * sd(hope[income_level == 1 & vaccination_status_flu == 0])/sqrt(hope_rural_yes_n),
    
    hope_lowedu_yes = mean(hope[education_level == 1 & vaccination_status_flu == 1]),
    hope_lowedu_yes_n = sum(education_level == 1 & vaccination_status_flu == 1),
    hope_lowedu_yes_upp = hope_lowedu_yes + 1.96 * sd(hope[education_level == 1 & vaccination_status_flu == 1])/sqrt(hope_lowedu_yes_n),
    hope_lowedu_yes_low = hope_lowedu_yes - 1.96 * sd(hope[education_level == 1 & vaccination_status_flu == 1])/sqrt(hope_lowedu_yes_n),
    
    hope_lowedu_no = mean(hope[education_level == 1 & vaccination_status_flu == 0]),
    hope_lowedu_no_n = sum(education_level == 1 & vaccination_status_flu == 0),
    hope_lowedu_no_upp = hope_lowedu_no + 1.96 * sd(hope[education_level == 1 & vaccination_status_flu == 0])/sqrt(hope_lowedu_no_n),
    hope_lowedu_no_low = hope_lowedu_no - 1.96 * sd(hope[education_level == 1 & vaccination_status_flu == 0])/sqrt(hope_lowedu_no_n),
  )
```
...
summary(glm(data = df_video_intervention, vaccination_status_flu ~ hope, family = binomial())) 
summary(lm(data = df_video_intervention, vaccination_status_flu ~ hope + vaccine_confidence, famil = binomial()))
...
model1 <- lm(data = df_video_intervention, vaccine_confidence ~ hope + age + gender 
             + residence + education + occupation + income)
model2 <- glm(data = df_video_intervention, vaccination_status_flu ~ hope + vaccine_confidence + age + gender + residence + education + occupation + income, family = "binomial")
sem <- mediate(model1, model2, treat = "hope", mediator = "vaccine_confidence", boot = T)
...
model1 <- lm(data = df_video_intervention, vaccine_confidence ~ hope)
model2 <- glm(data = df_video_intervention, vaccination_status_flu ~ hope + vaccine_confidence, family = "binomial")
sem0 <- mediate(model1, model2, treat = "hope", mediator = "vaccine_confidence", boot = T)
